...
<body>
    <ul class="navigation-bar">
        ...
        <li><a href="course_rec.php">Course Record</a></li>
        <li><a href="instructor_rec.php">Instructor Record</a></li>
        <li><a href="enrollment_rec.php">Enrollment Record</a></li>
    </ul>
    <div class="status">
    ...
    <div class="card-style">
        <h1>Add New Instructor Record</h1>
